...
function handleSignIn(event) {
    ...
    if (userData.isAdmin) {
        // Simple admin login - direct navigation
...
// Validate admin credentials - Temporarily allow all logins as admin
function validateAdminCredentials(email, password) {
    // Temporarily return true for any email/password combination
    return true;  // This will allow anyone to login as admin
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Redirect if on admin dashboard without admin privileges
...
// Update the openProfile function in app.js
