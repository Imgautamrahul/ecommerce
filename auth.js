...
function handleLogin(event) {
    ...
    if (user) {
        ...
        authState.isVendor = user.role === 'vendor';
        ...
        <div class="profile-container">
            ...
            <div class="profile-content">
                <div class="profile-info">
                    <p>Name: ${authState.currentUser.name}</p>
                    <p>Email: ${authState.currentUser.email}</p>
                    <p>Phone: ${authState.currentUser.phone}</p>
                    <p>Address: ${authState.currentUser.address}</p>
                </div>
